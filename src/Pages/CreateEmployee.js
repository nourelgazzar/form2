...
//       setuniversityErrorText("Department Name should not be left empty ");
//     } else if (/\d/.test(university)) {
//       setuniversityError(true);
//       setuniversityErrorText("Department Name should not include numbers ");
//     } else {
...
//       //   axios.post("http://localhost:8000/create", body).then(function(response) {
//       //     console.log(response);
//       //   });
//     }
//   };
